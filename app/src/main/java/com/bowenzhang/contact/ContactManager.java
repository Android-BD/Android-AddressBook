...
public class ContactManager {
    ...
    public static void addContact(Context context, ContactInfo contact) {
        ContentResolver resolver = context.getContentResolver();
    ...
    public static void updateContact(Context context, ContactInfo contact) {
        ContentResolver resolver = context.getContentResolver();
    ...
    public static void deleteContact(Context context, ContactInfo contact) {
        ContentResolver resolver = context.getContentResolver();
